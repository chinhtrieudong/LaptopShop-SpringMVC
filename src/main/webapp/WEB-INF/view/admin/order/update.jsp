                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12 align-items-center mx-auto">
                                                <form:form class="row" method="post" action="/admin/order/update"
                                                    ...
                                                    <h1 class="border border-0 border-bottom-1">Update a order</h1>
                                                    <hr>
                                                    <div class="mb-3 d-flex col-12">
                                                        <div style="margin-right: 30px;">
                                                            <label class="form-label">Order id = ${newOrder.id}</label>
                                                            <form:input type="text" class="form-control d-none"
                                                                path="id" />
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="mb-3 col-12 col-md-6">
                                                        ...
                                                        <form:select class="form-select" path="status">
                                                            <form:option value="SPENDING">SPENDING</form:option>
